...
import { Send, Linkedin, Twitter, AlertCircle, LogOut, Share2, Smile, Paperclip, XCircle, CheckCircle } from "lucide-react";
...
export default function SocialConnector() {
  ...
  useEffect(() => {
    // This effect loads tokens from storage on initial render
